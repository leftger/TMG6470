...
$tbl_name="RomneyComments"; // Table name
$web="Romneybio.php";
$link = mysql_connect($host, $username, $password) or die('Could not connect: ' . mysql_error());    
mysql_select_db($db_name) or die('Could not select database');


$listofcomments="SELECT Name,Vote,Coment,ID,BadVote FROM RomneyComments";
...
<td ><div id="thumb"><div id="thumbwrap"><div id="yesbox"><img src= "likeicon.png" alt="like" width="40px" height="40px"></div><?echo "<INPUT TYPE=\"IMAGE\" SRC=\"thumb.png\"  width=\"30px\" height=\"25px\" ONCLICK= window.location.href=\"Romneylike.php?id=$id&vote=$vte\">";?> </td></div></div>
<td ><font color=red><?echo $fullsort[0][4]?></td>
<td><div id="thumb"><div id="thumbwrap"><div id="yesbox"><img src= "dislike.png" alt="like" width="40px" height="40px"></div><?echo "<INPUT TYPE=\"IMAGE\" SRC=\"badthumb.png\"  width=\"30px\" height=\"25px\" ONCLICK= window.location.href=\"Romneyblike.php?id=$id&vote=$bvte\">";?> </td></div></div>
</tr>
<tr>
...
<td ><div id="thumb"><div id="thumbwrap"><div id="yesbox"><img src= "likeicon.png" alt="like" width="40px" height="40px"></div><?echo "<INPUT TYPE=\"IMAGE\" SRC=\"thumb.png\"  width=\"30px\" height=\"25px\" ONCLICK= window.location.href=\"Romneylike.php?id=$id2&vote=$vte2\">";?> </td></div></div>

<td><font color=red><?echo $newone[4]?></td>
<td><div id="thumb"><div id="thumbwrap"><div id="yesbox"><img src= "dislike.png" alt="like" width="40px" height="40px"></div><?echo "<INPUT TYPE=\"IMAGE\" SRC=\"badthumb.png\"  width=\"30px\" height=\"25px\" ONCLICK= window.location.href=\"Romneyblike.php?id=$id2&vote=$bvte2\">";?> </td></div></div>
</tr>
<tr>
...
<td ><div id="thumb"><div id="thumbwrap"><div id="yesbox"><img src= "likeicon.png" alt="like" width="40px" height="40px"></div><?echo "<INPUT TYPE=\"IMAGE\" SRC=\"thumb.png\"  width=\"30px\" height=\"25px\" ONCLICK= window.location.href=\"Romneylike.php?id=$id3&vote=$vte3\">";?> </td></div></div>

<td><font color=red><?echo $chop[$rand_keys[0]][4]?></td>
<td><div id="thumb"><div id="thumbwrap"><div id="yesbox"><img src= "dislike.png" alt="like" width="40px" height="40px"></div><?echo "<INPUT TYPE=\"IMAGE\" SRC=\"badthumb.png\"  width=\"30px\" height=\"25px\" ONCLICK= window.location.href=\"Romneyblike.php?id=$id3&vote=$bvte3\">";?> </td></div></div>

</tr>
<tr>
	<td colspan="5"><? echo "'".$chop[$rand_keys[0]][1] . "'"; ?></td>
</tr>
<!--
<tr>
	<?	$id4=$fullsort[3][3];
