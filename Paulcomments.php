...
$tbl_name="PaulComments"; // Table name
$web="paulbio.php";
$web2="Paulcomments";
...
$listofcomments="SELECT Name,Vote,Coment,ID,BadVote FROM PaulComments";
...
<td ><div id="thumb"><div id="thumbwrap"><div id="yesbox"><img src= "likeicon.png" alt="like" width="40px" height="40px"></div><?echo "<INPUT TYPE=\"IMAGE\" SRC=\"thumb.png\"  width=\"30px\" height=\"25px\" ONCLICK= window.location.href=\"Paullike.php?id=$id&vote=$vte\">";?> </td></div></div>
<td ><font color=red><?echo $fullsort[0][4]?></td>
<td><div id="thumb"><div id="thumbwrap"><div id="yesbox"><img src= "dislike.png" alt="like" width="40px" height="40px"></div><?echo "<INPUT TYPE=\"IMAGE\" SRC=\"badthumb.png\"  width=\"30px\" height=\"25px\" ONCLICK= window.location.href=\"Paulblike.php?id=$id&vote=$bvte\">";?> </td></div></div>
</tr>
<tr>
...
<td ><div id="thumb"><div id="thumbwrap"><div id="yesbox"><img src= "likeicon.png" alt="like" width="40px" height="40px"></div><?echo "<INPUT TYPE=\"IMAGE\" SRC=\"thumb.png\"  width=\"30px\" height=\"25px\" ONCLICK= window.location.href=\"Paullike.php?id=$id2&vote=$vte2\">";?> </td></div></div>

<td><font color=red><?echo $newone[4]?></td>
<td><div id="thumb"><div id="thumbwrap"><div id="yesbox"><img src= "dislike.png" alt="like" width="40px" height="40px"></div><?echo "<INPUT TYPE=\"IMAGE\" SRC=\"badthumb.png\"  width=\"30px\" height=\"25px\" ONCLICK= window.location.href=\"Paulblike.php?id=$id2&vote=$bvte2\">";?> </td></div></div>
</tr>
<tr>
...
<td ><div id="thumb"><div id="thumbwrap"><div id="yesbox"><img src= "likeicon.png" alt="like" width="40px" height="40px"></div><?echo "<INPUT TYPE=\"IMAGE\" SRC=\"thumb.png\"  width=\"30px\" height=\"25px\" ONCLICK= window.location.href=\"Paullike.php?id=$id3&vote=$vte3\">";?> </td></div></div>

<td><font color=red><?echo $chop[$rand_keys[0]][4]?></td>
<td><div id="thumb"><div id="thumbwrap"><div id="yesbox"><img src= "dislike.png" alt="like" width="40px" height="40px"></div><?echo "<INPUT TYPE=\"IMAGE\" SRC=\"badthumb.png\"  width=\"30px\" height=\"25px\" ONCLICK= window.location.href=\"Paulblike.php?id=$id3&vote=$bvte3\">";?> </td></div></div>
