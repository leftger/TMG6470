...
$listofcomments="SELECT Name,Vote,Coment,ID,BadVote FROM SantorumComments";
...
<td ><div id="thumb"><div id="thumbwrap"><div id="yesbox"><img src= "likeicon.png" alt="like" width="40px" height="40px"></div><?echo "<INPUT TYPE=\"IMAGE\" SRC=\"thumb.png\"  width=\"30px\" height=\"25px\" ONCLICK= window.location.href=\"Santorumlike.php?id=$id&vote=$vte\">";?> </td></div></div>
<td ><font color=red><?echo $fullsort[0][4]?></td>
<td><div id="thumb"><div id="thumbwrap"><div id="yesbox"><img src= "dislike.png" alt="like" width="40px" height="40px"></div><?echo "<INPUT TYPE=\"IMAGE\" SRC=\"badthumb.png\"  width=\"30px\" height=\"25px\" ONCLICK= window.location.href=\"Santorumblike.php?id=$id&vote=$bvte\">";?> </td></div></div>
</tr>
<tr>
